    ...
    <div>
        ...
        <nav class="navbar navbar-light bg-faded cst-navbar" style="background-color:#009688;">
            <a class="navbar-brand" style="color:#fff;" href="<?php echo base_url();?>">
                <img src="<?php echo base_url('assets/images/logo.png');?>"> Data Kandidat Calon Ketua Himpunan
            </a>
        </nav>
        <div class="container-fluid" style="margin:auto">
            <div class="row">
                <?php foreach($semua_calon as $calon):?>
                <div class="col-xs-6 col-md-12 col-centered" style="padding-bottom:10px;">

                    <a class="cst-card card text-center <?php echo ($calon->id == 1);?>" method="post">
                        <div class="card-block" style="margin-bottom:10px; ">
                            <img class="card-img-top" src="http://192.168.100.101/himamo/assets/voting/images/<?php echo $calon->picture;?>" class="img-fluid rounded-circle" alt="Responsive image">
                            <p class="card-title" style="text-center; border-bottom:1px solid #b2b2b2; padding-bottom:10px; padding-top:10px;"><b><?php echo $calon->nama;?> (<?php echo $calon->kelas;?>)</b></p>
                            
                            <div id="outer">
                            <b>VISI:</b>
                            <p><?php echo $calon->visi;?></p>
                            <b>MISI:</b>
                            <p style="text-align:left"><?php echo $calon->misi;?></p>
                            </div>
                        </div>
                    </a>
