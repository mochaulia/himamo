...
<html lang="en">
	...
	<title>HIMAMO | Div. Kreatifitas</title>
			...
			<div class="main-nav navbar-fixed-top" style="padding-right:20px;">
				...
				<div class="collapse navbar-collapse">
					<ul class="nav navbar-nav navbar-right">                 
						...
						<li class="active"><a href="<?php echo base_url('/divisi/kreatifitas/');?>"><i class="fa fa-pencil"></i> Kreativitas</a></li> 
		...
		<div class="heading wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms" style="margin-top: 90px;">
			<div class="container">
				<div class="text-center">
					<h2>Divisi Kreativitas</h2>
					<p>Kreativitas dalam KBBI artinya yaitu kemampuan untuk mencipta atau daya cipta. Dalam HIMAMO sendiri terdapat
					Divisi Kreativitas atau <i> Creativity Division</i> yang diharapkan sebagai sarana menyalurkan ide-ide kreatif
					dalam wujud karya maupun kegiatan di Lingkungan Himpunan maupun di luar Himpunan.</p>
				</div>
				<div class="text-center">
					<h3><strong>Fungsi :</strong></h3>
					<p>Menyalurkan ide-ide kreatif anggotanya dalam bentuk karya mau pun kegiatan.</p>
					<p>Dekorasi lingkungan Jurusan AE dan HIMAMO</p>
				</div>
				<div class="text-center">
					<h3><strong>Program Kerja Divisi</strong></h3>
					<p>Membuat Organigram Kepengurusan</p>
					<p>Lomba Dies Natalies Polman</p>
					<p>Wisuda Malam</p>
					<p>Wisuda Siang</p>
				</div>
			</div>
