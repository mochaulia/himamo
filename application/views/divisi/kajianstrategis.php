...
<html lang="en">
	...
	<title>HIMAMO | Div. Kajian Strategis</title>
			...
			<div class="main-nav navbar-fixed-top" style="padding-right:20px;">
				...
				<div class="collapse navbar-collapse">
					<ul class="nav navbar-nav navbar-right">                 
						...
						<li class="active"><a href="<?php echo base_url('/divisi/kajianstrategis/');?>"><i class="fa fa-line-chart"></i> Kajian Strategis</a></li>
		...
		<div class="heading wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms" style="margin-top: 90px;">
			<div class="container">
				<div class="text-center">
					<h2>Divisi Kajian Strategis</h2>
					<p>Fokus kerja divisi ini mempunyai peranan yang amat penting karena disinilah semua program kerja dan pemikiran-pemikiran strategis dan terstruktur dirancang.</p>
					<p>Divisi kajian strategis ini merancang dan merencanakan apa yang akan dilakukan himpunan ke depannya, melalui pemikiran matang dan kritis dikaji-lah semua program kerja yang dimiliki oleh Himpunan Mahasiswa Jurusan Teknik Otomasi Manufaktur dan Mekatronika.</p>
				</div>
			</div>
		</div>
