...
<html lang="en">
	...
	<title>HIMAMO | Div. Rumah Tangga</title>
			...
			<div class="main-nav navbar-fixed-top" style="padding-right:20px;">
				...
				<div class="collapse navbar-collapse">
					<ul class="nav navbar-nav navbar-right">                 
						...
						<li class="active"><a href="<?php echo base_url('/divisi/rumahtangga/');?>"><i class="fa fa-shopping-cart"></i> RMH TANGGA</a></li> 
		...
		<div class="heading wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms" style="margin-top: 90px;">
			<div class="container">
				<div class="text-center">
					...
					<p>Divisi Rumah Tangga merupakan sebuah divisi yang mengurusi pembendaharaan dan kesekretariatan HIMAMO.</p>
				</div>
			</div>
		</div>
