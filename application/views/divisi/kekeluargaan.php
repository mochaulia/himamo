...
<html lang="en">
	...
	<title>HIMAMO | Div. Kekeluargaan</title>
	...
	<body>
			...
			<div class="main-nav navbar-fixed-top" style="padding-right:20px;">
				...
				<div class="collapse navbar-collapse">
					<ul class="nav navbar-nav navbar-right">                 
						...
						<li class="active"><a href="<?php echo base_url('/divisi/kekeluargaan/');?>"><i class="fa fa-heart"></i>  Kekeluargaan</a></li>
		...
		<div class="heading wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms" style="padding-bottom: 45px;">
			<div id="carousel1" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner" role="listbox">
					<div class="item active"><img src="<?php echo base_url('assets/images/kegiatan/p4i/1.jpg');?>" alt="First slide image" class="center-block">
						<div class="carousel-caption">
							<h3></h3>
							<p></p>
						</div>
					</div>
					<div class="item"><img src="<?php echo base_url('assets/images/kegiatan/p4i/2.jpg');?>" alt="Second slide image" class="center-block">
						<div class="carousel-caption">
							<h3></h3>
							<p></p>
						</div>
					</div>
					<div class="item"><img src="<?php echo base_url('assets/images/kegiatan/p4i/3.jpg');?>" alt="Third slide image" class="center-block">
						<div class="carousel-caption">
							<h3></h3>
							<p></p>
						</div>
					</div>
					<div class="item"><img src="<?php echo base_url('assets/images/kegiatan/p4i/4.jpg');?>" alt="Fourth slide image" class="center-block">
						<div class="carousel-caption">
							<h3></h3>
							<p></p>
						</div>
		...
		<div class="container" style="margin-bottom:90px;">
			<div class="text-center col-sm-6 col-sm-offset-3">
				<h2>Divisi Kekeluargaan</h2>
				<p>Di saat kita jauh dari orang-orang yang kita sayangi di rumah, Divisi kekeluargaan adalah divisi yang
				tepat untuk menjadi keluarga baru kita di Himamo. Karena tujuan utama dari divisi ini adalah mempererat tali
				silaturahmi antar anggota himpunan. Selain daripada itu, Himpunan Mahasiswa Jurusan Teknik Otomasi Manufaktur 
				dan Mekatronika sendiri pada dasarnya berlandaskan kekeluargaan.</p>
			</div>
		</div>
		<footer id="footer">
