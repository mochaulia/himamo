...
<html lang="en">
	...
	<title>HIMAMO | Div. Kominfo</title>
	...
	<body>
			...
			<div class="main-nav navbar-fixed-top" style="padding-right:20px;">
				...
				<div class="collapse navbar-collapse">
					<ul class="nav navbar-nav navbar-right">                 
						<li class="active"><a href="<?php echo base_url('/divisi/kominfo/');?>"><i class="fa fa-comments"></i> Kominfo</a></li> 
		...
		<div class="heading wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms" style="margin-top:90px; padding-bottom: 45px;">
			<div class="text-center col-sm-8 col-sm-offset-2" >
				<img class="" style="width:50%" src="<?php echo base_url('/assets/images/gif/wrapper-img.gif');?>" alt="kominfo">
			</div>
		</div>
		...
		<div class="container" style="margin-bottom:90px;">
			<div class="text-center col-sm-6 col-sm-offset-3">
            	...
            	<p>Memiliki kompetensi inti pada pengelolaan, penyeleksian, desain, informatika, dan teknologi. <strong>Kominfo</strong> yang berada di Himamo sendiri berperan penting bagi kelangsungan informasi yang bersangkutan dengan dunia luar (global) dan internal himamo sendiri.</p>
			</div>
		</div>
		<footer id="footer">
